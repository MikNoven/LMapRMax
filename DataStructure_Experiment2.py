...
import os 
os.chdir('/Users/gdf724/Code/LMapRMax_paradigm')
import pandas as pd
...
subjlist = glob(os.path.join(datapath,'ID*'))
grammar_version_col = []
subjcol_gv = []
...
element_nbr_template = list(range(1,nbrOfItems+1))*nbrOfSequences*nbrOfBlocks
